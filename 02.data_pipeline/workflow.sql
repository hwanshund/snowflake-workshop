...
-- at(LAST_QUERY_ID() => '2025-09-28 22:10:05.666 -0700'::timestamp_tz);
-- at (offset => -60 * 5);
before(statement => '01bf5e3a-0001-0d95-0000-0001077294a1');
...
at(timestamp => '2025-09-28 22:14:01.684 -0700'::timestamp_tz);
